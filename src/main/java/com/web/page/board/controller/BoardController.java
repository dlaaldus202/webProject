package com.web.page.board.controller;
...
@Slf4j
@Controller
// Model에 "board"라는 이름으로 데이터가 등록될 때, 세션에도 동일한 이름으로 객체를 등록해라.
@SessionAttributes("board")
public class BoardController {

	//Path지정 
	private static final String FOLER_PATH = "/Page/Board";
	
	@Autowired
	private BoardService boardService;
	
	// 글 등록 화면으로 이동
	@GetMapping(FOLER_PATH +"/insertBoardView")
